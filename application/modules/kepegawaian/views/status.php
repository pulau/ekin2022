            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Tambah Data Status Kawin</h3>
                      <div class="box-tools"></div>
                    </div>
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formStatus','role'=> 'form'))?>
                                <div class="form-group">
                                    <label>Bagian</label>
                                    <input type="text" id="status_nama" name="status_nama" class="form-control" placeholder="Status Kawin">
                                    <input type="hidden" id="status_id" name="status_id" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label>Bagian</label>
                                ...
                                <div class="form-actions">
                                    <button type="button" id="btnSaveStatus" class="btn btn-info">Simpan</button>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table_status" class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
