        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formPendidikan','role'=> 'form'))?>
                                <div class="form-group">
                                    <label>Bagian</label>
                                    <input type="text" id="pendidikan_nama" name="pendidikan_nama" class="form-control" placeholder="Pendidikan">
                                    <input type="hidden" id="pendidikan_id" name="pendidikan_id" readonly="readonly">
                                </div>
                                <div class="form-actions">
                                    <button type="button" id="btnSavePendidikan" class="btn btn-info">Simpan</button>
