        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formJabatan','role'=> 'form'))?>
                                <div class="form-group">
                                    <label>Bagian</label>
                                    <input type="text" id="jabatan_nama" name="jabatan_nama" class="form-control" placeholder="Jabatan">
                                    <input type="hidden" id="jabatan_id" name="jabatan_id" readonly="readonly">
                                </div>
                                <div class="form-actions">
                                    <button type="button" id="btnSaveJabatan" class="btn btn-info">Simpan</button>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table_jabatan" class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
