        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formAgama','role'=> 'form'))?>
                                <div class="form-group">
                                    <label>Agama</label>
                                    <input type="text" id="agama_nama" name="agama_nama" class="form-control" placeholder="Agama">
                                    <input type="hidden" id="agama_id" name="agama_id" readonly="readonly">
                                </div>
                                <div class="form-actions">
                                    <button type="button" id="btnSaveAgama" class="btn btn-info">Simpan</button>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table_agama" class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
