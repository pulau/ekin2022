            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table_prestasi_pegawai" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th> Aktifitas (Bobot 70%) </th>
                                    <th> Perilaku (Bobot 10%) </th>
                                    <th> Serapan (Bobot 20%) </th>
                                    <th> Total Nilai </th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Sinkronisasi Capaian</h4>
        </div>
...
<!-- /.modal -->
  <?php
  $this->load->view('prestasi_kerjaJs');
