            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Tambah Penyerapan</h3>
                      <div class="box-tools"></div>
                    </div>
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formPenyerapan','role'=> 'form'))?>
                                ...
                                <div class="form-group">
                                    <label>Nilai</label>
                                    <input type="text" id="nilai" name="nilai" class="form-control" placeholder="Masukan Angka" onkeypress="return numbersOnly(event);">
                                </div>
                                <div class="form-actions">
                                    <button type="button" id="btnSavePenyerapan" class="btn btn-info">Simpan</button>
                ...
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">List Penyerapan</h3>
                      <div class="box-tools">
                      </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table id="table_penyerapan" class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
