...
class Capaian_kinerja extends MY_Controller {
    ...
    public function ajax_get_jml_waktu_efektif(){
        ...
        if(count((array)$waktu_kurang) > 0) {
            ...
            //TOTAL PENGURANGAN
            $total_pengurangan = $menit_alfa + $menit_terlambat + $menit_plg_cepat + $menit_izin + $menit_sakit + $menit_izin_setengah_hari + $menit_sakit_srt_dokter + $menit_cuti_sakit;
            $hasil_pengurangan = $menit_kerja - $total_pengurangan;


            //TOTAL PENAMBAHAN
            $total_penambahan = $menit_cuti_alasan_penting + $menit_isoman + $menit_ranapc19 + $menit_cuti_tahunan + $menit_cuti_bersalin + $menit_cuti_besar + $menit_dinas_luar_akhir + $jml_dinas_luar_awal + $jml_tidak_terbaca + $jml_dinas_luar_penuh + $jml_cuti_bersalin_ak3;
