...
class Review_cuti_model extends CI_Model {
    var $column = array('alasan','jeniscuti_nama','pengganti_nama','pegawai_nama','pj_cuti');
    var $column_order = array('cuti_id','pegawai_nama','jeniscuti_nama','tgl_pengajuan','tgl_awal','tgl_akhir','alasan','pengganti_nama','pj_cuti','approve_by_pj','review_status','approval_status');
    ...
    public function get_review_list($filter_bln){
    ...
    public function count_review_all($filter_bln){
        $this->db->from('v_cutipegawai');
    ...
    public function count_review_filtered($filter_bln){
        $this->db->from('v_cutipegawai');
    ...
    function get_pegawai_by_id($id){
        $query = $this->db->get_where('m_pegawai', array('id_pegawai' => $id), 1, 0);
