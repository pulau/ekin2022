...
class Ecuti extends MY_Controller {
    public $data = array();
    ...
    function index()
    {
        $is_permit = $this->aauth->control_no_redirect('dashboard_ecuti');
        if(!$is_permit) {
        ...
        $perms = "dashboard_ecuti";
        $comments = "Halaman Dashboard E-Cuti";
        $this->aauth->logit($perms, current_url(), $comments);
    	$this->load->view('ecuti', $this->data);
    }
}