...
class Sistem_admin extends MY_Controller {
    public $data = array();
    ...
    function __construct()
    {
        ...
        $this->load->model('Sistem_admin_model');
    ...
    function index()
    {
        $is_permit = $this->aauth->control_no_redirect('dashboard_sys_admin');
        if(!$is_permit) {
        ...
        $perms = "dashboard_sys_admin";
        $comments = "Halaman Dashboard Sistem Admin";
        $this->aauth->logit($perms, current_url(), $comments);
    	$this->load->view('sistem_admin', $this->data);
    }
}
