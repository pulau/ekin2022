            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Tambah Indikator Program</h3>
                      <div class="box-tools"></div>
                    </div>
                    <div class="box-body">
                        <div class="col-lg-4">
                            <?php echo form_open('#',array('id' => 'formInpro','role'=> 'form'))?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="indikator_program" name="indikator_program" class="form-control" placeholder="Indikator Program">
                                    <input type="hidden" id="indikator_program_id" name="indikator_program_id" readonly="readonly">
                                </div>
                                <div class="form-actions">
                                    <button type="button" id="btnSaveInpro" class="btn btn-info">Simpan</button>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table_inpro" class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
