        ...
        <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="small-box bg-olive">
                    ...
                    <p>Total Pasien PKC. Kalideres</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-aqua-gradient">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Semanan 1</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-green">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Semanan 2</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-yellow">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Kalideres</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-purple">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Pegadungan 1</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-red">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Pegadungan 2</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-navy">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Pegadungan 3</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
             ...
             <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-navy">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Pegadungan 4</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-navy">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Tegal Alur 1</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-navy">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Tegal Alur 2</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="small-box bg-navy">
                    <div class="inner">
                      ...
                      <p>Total Pasien PKL. Tegal Alur 3</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-ios-people"></i>
                    </div>
